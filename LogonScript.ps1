...
# Edit to fit your environment
 ...
 $UserFileLocation = "\\..\Profiles$\$env:username\1.txt"
#------------------------------------------------------------
...
#------------------------------------------------------------
 #Enter the txt you wan to appear in the window body
...
#------------------------------------------------------------
 #Enter the total time in seconds befor auto logoff
 $TimeSec = 60 #in seconds 
#
#############################################################
 ...
 function Call-MainForm_psf
{
 ...
 Shutdown /l /f $session /server:$computer
